    ...
    if params["user_pool_id"] != "":
        ...
        NagSuppressions.add_stack_suppressions(
            ...
            suppressions=[
                ...
                NagPackSuppression(id="AwsSolutions-APIG1", reason="API Gateway access logging handled at CloudFront level via web stack"),
                NagPackSuppression(
                    id="AwsSolutions-APIG4",
                    reason="OPTIONS method is generated by CDK and handled by APIG",
                ),
                NagPackSuppression(id="AwsSolutions-APIG6", reason="CloudWatch execution logging not needed - errors are captured in Lambda CloudWatch logs"),
                NagPackSuppression(
        ...
        NagSuppressions.add_stack_suppressions(
            ...
            suppressions=[
                ...
                NagPackSuppression(id="AwsSolutions-S1", reason="Static website hosting bucket - access logs not needed for non-sensitive public content"),
                NagPackSuppression(
                    id="AwsSolutions-S10",
                    reason="SSL enforcement handled by CloudFront OAC - bucket is not directly accessible",
                ),
                NagPackSuppression(
                    id="AwsSolutions-IAM4", reason="CDK-generated policy"
                ),
