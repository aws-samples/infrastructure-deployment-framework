...
function logout() {
  ...
  window.location.href = `https://auth.${window.location.hostname.replace(/^admin\./, '')}/logout?client_id=7gh6kfj08tuf5t4thh75ek8fvt&redirect_uri=https://${window.location.hostname}&response_type=code`;
}
