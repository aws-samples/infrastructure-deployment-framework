...
class CdkAppPipelineStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const sourceBucket = new s3.Bucket(this, "CskSourceBucket", {
      versioned: true, publicReadAccess: false,
    ...
    // const trail = new cloudtrail.Trail(this, 'CloudTrail', { isMultiRegionTrail: false, removalPolicy: RemovalPolicy.DESTROY, bucket: sourceBucket, s3KeyPrefix: "cloudtrail" });
